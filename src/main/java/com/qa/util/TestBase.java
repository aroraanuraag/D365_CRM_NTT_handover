...
public class TestBase {
	...
	public TestBase()   // This is the Constructor - Constructor name is same as Class name.
	{
		...
		try {
			...
			prop = new Properties();
			FileInputStream ip = new FileInputStream("C:\\TEST Automation - Selenium Java\\1. Latest Cucumber Working File - Test Automation BDD - 07th June 2021\\Cucumber_with_POM_TestNG_ParallelExecution\\src\\main\\java\\com\\qa\\config\\config.properties");
			prop.load(ip);
